...
TYPE
	...
	Driver_CS_typ : 	STRUCT 
		...
		Sev : ARRAY[0..MAX_DRIVER_AB_WAIT_IDX]OF DINT;
		CTON_DbOn : ARRAY[0..MAX_DRIVER_AB_WAIT_IDX]OF CTON;
		CTON_DbOff : ARRAY[0..MAX_DRIVER_AB_WAIT_IDX]OF CTON;
	...
	Driver_CS_Par_typ : 	STRUCT 
		Mon : ARRAY[0..MAX_DRIVER_CS_WAIT_IDX]OF Driver_Par_Mon_typ;
	...
	Driver_AB_Par_typ : 	STRUCT 
		Mon : ARRAY[0..MAX_DRIVER_AB_WAIT_IDX]OF Driver_Par_Mon_typ;
